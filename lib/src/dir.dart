...
Stream<(File, File)>
copyDirRec(Directory dirIn, Directory dirOut, {bool isCopyFile = true, bool Function(String)? filter}) async* {
...
Stream<(File, File)>
syncDir(Directory dir1, Directory dir2, {bool isCopyFile = true, bool Function(String)? filter}) async* {
